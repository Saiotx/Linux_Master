...
const HomeView: React.FC<HomeViewProps> = ({ sections, unlockedSection, onSelectSection }) => {
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-black text-green-500 tracking-tighter">LINUX ACADEMY</h1>
